	...
	blocks.registerBlockType( 'wpdevart-likebox/likebox', {
		...
		edit: function( props ) {
			...
			function create_content(){
				...
				wpda_likebox_fields.push(wpda_likebox_lb_simple_select("stream",{"show":"Show","hide":"Hide"},"Show/Hide Page Posts:","Show/Hide the Page Posts from the Facebook Like box.",true));
