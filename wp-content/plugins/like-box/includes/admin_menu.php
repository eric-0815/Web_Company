		...
		<div class="main_parametrs_group_div">
			...
			<div class="inside_information_div">
				...
				<tbody> 
               		<tr>
						<td>
							Enable/Disable the Popup <span title="Select Enable/Disable to show or hide popup." class="desription_class">?</span>
						</td>
						<td>
                	...
                	<tr>
						<td>
							Show/Hide the like box Popup on these pages  <span class="pro_feature"> (pro)</span><span title="Choose the action to show or hide like box popup from the below list." class="desription_class">?</span>
						</td>
						<td>
                    ...
                    <tr>
						<td>
							Page ID <span title="Type here your Facebook like box page URL(without https://www.facebook.com/, if your Facebook page URL is https://web.facebook.com/AnIMals then type here just the AnIMals)." class="desription_class">?</span>
						</td>
						<td>
                    ...
                    <tr>
						...
						<td>
							Show the border <span class="pro_feature"> (pro)</span>  <span title="Show/hide the Facebook like box border." class="desription_class">?</span>
						</td>
						<td>
                  ...
                  <tr>
                    ...
                    <tr>
						<td>
							Show the latest posts <span title="Choose to show or hide the latest posts from Facebook." class="desription_class">?</span>
						</td>
						<td>
                           <select id="like_box_stream">
                     ...
                     <tr>
						<td>
							Like box language <span title="Type the Facebook Like box language code(for example en_US)." class="desription_class">?</span>
						</td>
						<td>
		...
		<div class="main_parametrs_group_div " >
			...
			<div class="inside_information_div">
				...
				<tbody> 
               		<tr>
						<td>
							Enable/Diasable the Sticky box <span title="Select Enable/Disable to show or hide Sticky box." class="desription_class">?</span>
						</td>
						<td>
                	...
                	<tr>
						<td>
							Show/Hide the like box sticky box on these pages <span class="pro_feature"> (pro)</span><span title="Choose the action to show or hide like box sticky box from the below list." class="desription_class">?</span>
						</td>
						<td>
                           <select class="pro_select">
                                <option value="show">Show on the below selected list</option>
                  ...
                  <tr>
						<td>
							Show the Users Faces <span title="Select to Show/Hide Users Faces" class="desription_class">?</span>
						</td>
						<td>
                   ...
                   <tr>
                    ...
                    <tr>
						<td>
							Show the latest posts  <span title="Show/Hide the latest posts from your Facebook Like box." class="desription_class">?</span>
						</td>
						<td>
