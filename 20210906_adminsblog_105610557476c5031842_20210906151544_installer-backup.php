...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20210906_adminsblog_105610557476c5031842_20210906151544_archive.zip';
	const ARCHIVE_SIZE		 = '111565395';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '1056105-06151544';
    const SECONDARY_PACKAGE_HASH = '0e54669-06151544';
	const VERSION			 = '1.4.2';
